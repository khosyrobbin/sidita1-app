...
<head>
    ...
    <title>Create account - Sidita</title>
            ...
            <div class="flex flex-col overflow-y-auto md:flex-row">
                <div class="h-32 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-cover w-full h-full dark:hidden"
                        src="{{ asset('template') }}/assets/img/create-account-office.jpeg" alt="Office" />
                    <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block"
                        src="{{ asset('template') }}/assets/img/create-account-office-dark.jpeg" alt="Office" />
                </div>
                    ...
                    <div class="w-full">
                        <form action="{{ route('register') }}" method="post">
                            ...
                            <label class="block text-sm">
                                ...
                                <input id="nip" type="nip" name="nip" value="{{ old('nip') }}" required
                                    autocomplete="nip"
